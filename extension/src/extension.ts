...
export function activate(context: vscode.ExtensionContext) {
	...
	context.subscriptions.push(vscode.commands.registerCommand("fuwafuwa.toggle", fuwafuwa.command.toggle))
	context.subscriptions.push(vscode.commands.registerCommand("fuwafuwa.configure", fuwafuwa.command.configure))
